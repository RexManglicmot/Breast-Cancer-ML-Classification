...
## Cleaning the Data
Let's create a new object of the orginal data and change the variable names. Some of them like Classification is too long and let's change them to a name much shorter.
```{r}
